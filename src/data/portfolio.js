export const portfolio = {
  ...
  coreStack: ['React.js', 'TypeScript', 'Redux', 'Recoil', 'REST', 'Git', 'Agile'],

  skills: [
    { group: 'Frontend',          items: ['React.js', 'TypeScript', 'HTML', 'CSS'] },
    { group: 'State Management',  items: ['Redux', 'Context API', 'Recoil', 'Reducers'] },
    { group: 'Architecture',      items: ['RESTful APIs', 'SOA', 'Component Design'] },
    { group: 'Tools & Delivery',  items: ['Git', 'GitHub', 'Agile / Scrum', 'JIRA'] },
  ],
